...
void GameStage::draw()
{
	...
	case 2:
		...
		DrawTextEx(GetFontDefault(), getFormattedScore(game->player->score).c_str(), (Vector2){ 30, 8 }, 10, 3, WHITE);
...
string GameStage::getFormattedScore(int score)
{
	if (to_string(score).length() == 1)
	{
